...
Execution halted
ERROR: lazy loading failed for package ‘UniProt.ws’
* removing ‘/tmp/tmp/built/UniProt.ws’

The downloaded source packages are in
	‘/tmp/RtmpfyPhDY/downloaded_packages’
...
Warning message:
In install.packages(...) :
  installation of package ‘UniProt.ws’ had non-zero exit status
