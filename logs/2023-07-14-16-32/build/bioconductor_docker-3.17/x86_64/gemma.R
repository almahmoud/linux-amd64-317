...
trying URL 'https://packagemanager.posit.co/cran/__linux__/jammy/latest/src/contrib/magick_2.7.4.tar.gz'
Content type 'binary/octet-stream' length 5152965 bytes (4.9 MB)
==================================================
downloaded 4.9 MB
...
Content type 'binary/octet-stream' length 3013219 bytes (2.9 MB)
==================================================
downloaded 2.9 MB
